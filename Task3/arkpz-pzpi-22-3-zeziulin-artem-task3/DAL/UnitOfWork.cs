...
namespace DAL
{
    public class UnitOfWork : IDisposable
    {
        ...
        private DatabaseAdminRepository _databaseAdminRepository;

        public DatabaseAdminRepository DatabaseAdminRepository
        {
            get
            {
                _databaseAdminRepository ??= new DatabaseAdminRepository(_appContext,
                        new Logger<DatabaseAdminRepository>(_loggerFactory));

                return _databaseAdminRepository;
            }
        }
